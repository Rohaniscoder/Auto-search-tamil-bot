...
PICS = (environ.get('PICS', 'https://telegra.ph/file/7b05b44ff255c3ac0b735.jpg')).split() #SAMPLE PIC
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001406993373')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001974180754')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/+0silU4tAg21lMTU1')
